...
Train a LoRA adaptor, achieves 4.7%. With more parameter search, shall be able to achieve 4.9%.  
The lrm team does full model fine tuning and achieves 5%.

But as the model is very weak, it does not make sense to do further parameter sweeping
