...
runs=(
    ...
    "--LR 2e-4 --WEIGHT_DECAY 0.005 --WARMUP_STEPS 2000 --TRAIN_BATCH_SIZE 32 --LORA_RANK 32 --LORA_RATIO 2 --LORA_DROPOUT 0.25 --TOTAL_STEPS 300000 --ACC_STEP 3 --RUN_NUM 0 --CHECK_POINT 0"   # 64 out of memory
)
