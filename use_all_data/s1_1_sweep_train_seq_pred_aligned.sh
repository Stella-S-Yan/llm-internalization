...
runs=(
    # "--LR 4e-4 --WARMUP_STEPS 1000 --TRAIN_BATCH_SIZE 16 --LORA_RATIO 2"
    "--LR 4e-4 --WARMUP_STEPS 1000 --TRAIN_BATCH_SIZE 32 --LORA_RATIO 2 --TOTAL_STEPS 20000"
    # "--LR 4e-4 --WARMUP_STEPS 1000 --TRAIN_BATCH_SIZE 16 --LORA_RATIO 2 --TOTAL_STEPS 20000 --POLY_POW 0.5"
)
