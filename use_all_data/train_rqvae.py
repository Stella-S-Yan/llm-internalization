...
def train():
    ...
    data_variance = np.var(raw_item_embeddings).item()
    ...
    hp = {
        ...
        "vqvae": {
            ...
            "commitment_cost": 1.0,     # 17% collision rate, need to increase 0.3~0.5
    ...
    for step in range(total_steps):
        ...
        if reconstruction_loss < best_reconstruction_loss and usage_ratio >0.8:
        # if loss < best_loss:
