...
# # --- Not Tag Templates ---
# PROMPT_TEMPLATE = """
# {uid} {sid_year_genre_list} {predict}
# """

# TARGET_TEMPLATE = """
# {target_year} {target_genre} {target_sid} {eos}
# """
...
def main():
    ...
    metadata_path = os.path.join(config.PROCESSED_DATA_DIR, f"{config.DATA_SOURCE}_{config.REVIEW_TYPE}_sid_df.parquet")
